...
class TestRiskKelly(unittest.TestCase):
    ...
    def test_fractional_kelly_with_zero_spread(self):
        """Проверка фракционного Kelly с нулевым разбросом."""
        market: Market = Market(spread=0)
    ...
    def test_position_size_within_initial_capital(self):
        ...
        market: Market = Market(initial_capital=1000)
    ...
    def test_assess_outcome_probability_in_range(self):
        ...
        outcome_probabilities: Dict[str, float] = {outcome: 0.5 for outcome in ['outcome1', 'outcome2']}
